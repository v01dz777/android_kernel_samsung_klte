...
#elif defined(CONFIG_MACH_KACTIVELTE_EUR) || defined(CONFIG_MACH_KACTIVELTE_ATT) || defined(CONFIG_MACH_KACTIVELTE_CAN) || defined(CONFIG_MACH_KACTIVELTE_SKT) || defined(CONFIG_MACH_KACTIVELTE_DCM)
static sec_bat_adc_table_data_t temp_table[] = {
	{26009,	900},
	{26280,	850},
	{26600,	800},
